...
function DealSPMoi() {
   ...
   useEffect ( () => {
      fetch("http://localhost:3000/spmoi/4")
      .then(res=>res.json()).then(data => ganListSP(data));
   } , []);

    return (
        <div className="hot-product-main row-gird">
        <div className="hot-product-main-category">
            <img src="https://www.tncstore.vn/media/category/cat_big_79_1721382171.jpg" alt="" />
        </div>
